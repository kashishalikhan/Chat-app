...
const ChatContainer = ({ selectedUser, setSelectedUser }) => {
  ...
  return selectedUser ? (
    <div className="h-full overflow-scroll relative backdrop-blur-lg text-white">
      {/* ----------------header--------------------- */}
      <div
        className="flex items-center justify-between gap-3 py-3 mx-4 border-b border-stone-500
      "
      >
    ...
    <div className="h-full flex flex-col items-center justify-center text-center p-6 text-white backdrop-blur-md bg-white/5">
      <img src={assets.logo_icon} className="max-w-16 mb-4" alt="Logo" />
